...
class _Translations$networkInterfacesPage$es_ES extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'De forma predeterminada, MySender utiliza todas las interfaces de red disponibles. Aquí puede desactivar las redes no deseadas. Debe reiniciar el servidor para aplicar los cambios.';
  @override
...
class _Translations$webSharePage$es_ES extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'MySender utiliza un certificado autofirmado. Necesitas aceptarlo en el navegador.';
  @override
...
class _Translations$aboutPage$es_ES extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Sobre MySender';
  @override
  List<String> get description => [
    'MySender es una aplicación libre, de código abierto, que te permite compartir archivos y mensajes de forma segura con dispositivos cercanos a través de tu red local sin necesidad de conexión a Internet.',
...
class _Translations$donationPage$es_ES extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'MySender es libre, open source y no contiene anuncios. Si te gusta la aplicación puedes ayudar al desarrollo con una donación.';
  @override
...
class _Translations$tray$es_ES extends Translations$tray$en {
  ...
  @override
  String get close => 'Cerrar MySender';
  @override
...
class _Translations$settingsTab$general$es_ES extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Mostrar MySender en el menú contextual';
  @override
...
class _Translations$settingsTab$other$es_ES extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Apoya a MySender';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$es_ES extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'MySender no puede encontrar otros dispositivos sin tener permiso para escanear la red local. Por favor, concede este permiso en los ajustes.';
  @override
...
class _Translations$dialogs$sendModeHelp$es_ES extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Los destinatarios que no tengan MySender instalado pueden descargar los archivos seleccionados abriendo el enlace en su navegador.';
}
