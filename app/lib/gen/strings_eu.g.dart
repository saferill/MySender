...
class _Translations$networkInterfacesPage$eu extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Lehenespenez, MySender-ek eskuragarri dauden sare-interfaze guztiak erabiltzen ditu. Nahi ez dituzun sareak hemen baztertu ditzakezu. Zerbitzaria berrabiarazi behar duzu aldaketak aplikatzeko.';
  @override
...
class _Translations$webSharePage$eu extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'MySender-ek autosinatutako zertifikatuak erabiltzen ditu. Nabigatzailean onartu behar duzu';
  @override
...
class _Translations$aboutPage$eu extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'MySender buruz';
  @override
  List<String> get description => [
    'MySender doako eta kode irekiko aplikazio bat da, gertuko gailuekin fitxategiak eta mezuak modu seguruan partekatzeko aukera ematen dizuna zure sare lokalaren bidez, interneteko konexiorik behar izan gabe.',
...
class _Translations$donationPage$eu extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'MySender doakoa da, kode irekikoa eta iragarkirik gabea. Aplikazioa gustuko baduzu, garapena dohaintza batekin lagun dezakezu.';
  @override
...
class _Translations$tray$eu extends Translations$tray$en {
  ...
  @override
  String get close => 'Itxi MySender';
  @override
...
class _Translations$settingsTab$general$eu extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Erakutsi MySender testuinguru menuan';
  @override
...
class _Translations$settingsTab$other$eu extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'MySender Lagundu';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$eu extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Sare lokala eskaneatzeko baimenik gabe, MySender-ek ezin ditu inguruko gailuak aurkitu. Mesedez, onartu baimen hau ezarpenetan.';
  @override
...
class _Translations$dialogs$sendModeHelp$eu extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'MySender instalatuta ez duten hartzaileak fitxategiak eskuratu ahali zango dituzte lotura nabigatzailean zabalduz.';
}
