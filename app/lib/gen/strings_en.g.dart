...
class Translations$networkInterfacesPage$en {
  ...
  /// en: 'By default, MySender uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, MySender uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class Translations$receiveOptionsPage$en {
  ...
  /// en: '(MySender folder)'
  String get appDirectory => '(MySender folder)';
...
class Translations$webSharePage$en {
  ...
  /// en: 'MySender uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'MySender uses a self-signed certificate. You need to accept it in your browser.';
...
class Translations$aboutPage$en {
  ...
  /// en: 'About MySender'
  String get title => 'About MySender';

  List<String> get description => [
    'MySender is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
...
class Translations$donationPage$en {
  ...
  /// en: 'MySender is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'MySender is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class Translations$tray$en {
  ...
  /// en: 'Quit MySender'
  String get close => 'Quit MySender';
...
class Translations$settingsTab$general$en {
  ...
  /// en: 'Show MySender in context menu'
  String get showInContextMenu => 'Show MySender in context menu';
...
class Translations$settingsTab$other$en {
  ...
  /// en: 'Support MySender'
  String get support => 'Support MySender';
...
class Translations$dialogs$localNetworkUnauthorized$en {
  ...
  /// en: 'MySender can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'MySender can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class Translations$dialogs$sendModeHelp$en {
  ...
  /// en: 'Recipients who do not have MySender installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have MySender installed can download the selected files by opening the link in their browser.';
}
