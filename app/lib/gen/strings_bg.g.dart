...
class _Translations$networkInterfacesPage$bg extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'По подразбиране, MySender използва всички налични мрежови интерфейси. Тук можете да изключите нежелани мрежи. Трябва да рестартирате сървъра, за да приложите промените.';
  @override
...
class _Translations$receiveOptionsPage$bg extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(папка на MySender)';
  @override
...
class _Translations$webSharePage$bg extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'MySender използва самоподписан сертификат. Трябва да го приемете във вашия браузър.';
  @override
...
class _Translations$aboutPage$bg extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Относно MySender';
  @override
  List<String> get description => [
    'MySender е безплатно приложение с отворен код, което ви позволява сигурно да споделяте файлове и съобщения с устройства наблизо през вашата локална мрежа, без да се нуждаете от интернет връзка.',
...
class _Translations$donationPage$bg extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'MySender е безплатен, с отворен код и без никакви реклами. Ако харесвате приложението, можете да подкрепите разработката с дарение.';
  @override
...
class _Translations$tray$bg extends Translations$tray$en {
  ...
  @override
  String get close => 'Излезте от MySender';
  @override
...
class _Translations$settingsTab$general$bg extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Покажи MySender в контекстното меню';
  @override
...
class _Translations$settingsTab$other$bg extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Поддръжка на MySender';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$bg extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'MySender не може да намери други устройства без разрешение за сканиране на локалната мрежа. Моля, предоставете това разрешение в настройките.';
  @override
...
class _Translations$dialogs$sendModeHelp$bg extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Получателите, които нямат инсталиран MySender, могат да изтеглят избраните файлове, като отворят връзката в своя браузър.';
}
