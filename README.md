...
MySender is a fast, open-source, cross-platform local file sharing application that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.

> **Note**: MySender is based on the open-source project [LocalSend](https://github.com/localsend/localsend), licensed under the [Apache License 2.0](LICENSE).
